...
export default function Neet11th() {
  return (
    <CourseLayout
      title="Your Ultimate Destination for"
      subtitle="11th Chemistry Preparation for NEET"
      description="At Decipher Academy, we provide an extensive learning experience to help NEET aspirants excel in Chemistry. Our course covers the entire 11th-grade Chemistry syllabus, ensuring a strong foundation for your success."
      features={features}
